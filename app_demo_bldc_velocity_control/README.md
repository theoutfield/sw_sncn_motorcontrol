...
Other dependencies: [module_common][module_common] [module_statemachine][module_statemachine] [module_nodeconfig][module_nodeconfig]@[sc_somanet-base][sc_somanet-base] 
