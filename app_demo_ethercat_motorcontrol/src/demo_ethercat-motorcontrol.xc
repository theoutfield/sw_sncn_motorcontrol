...
int main(void)
{
    ...
    par
    {
        ...
        on tile[1] :
        {
            ecat_motor_drive(pdo_out, pdo_in, coe_out, c_signal,
            ...
            par
            {
                /* Position Control Loop */
                {
                    ...
                    position_control(position_ctrl_params, hall_params, qei_params,
                                     SENSOR_USED, c_hall_p4, c_qei_p4, c_position_ctrl,
                                     c_commutation_p3);
                }
                ...
                /* Velocity Control Loop */
                {
                    ...
                    velocity_control(velocity_ctrl_params, sensor_filter_params, hall_params,
                                     ...
                                     c_velocity_ctrl, c_commutation_p2);
                }
            ...
            par
            {
                ...
                /* Motor Commutation loop */
                {
                    ...
                    commutation_sinusoidal(c_hall_p1,  c_qei_p1, c_signal, c_watchdog,
                                           ...
                                           c_pwm_ctrl, p_ifm_esf_rstn_pwml_pwmh, p_ifm_coastn,
                                           p_ifm_ff1, p_ifm_ff2, hall_params, qei_params,
                                           commutation_params);   // channel priority 1,2,3
                }
