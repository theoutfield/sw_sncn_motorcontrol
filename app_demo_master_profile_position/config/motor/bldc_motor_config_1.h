 ...
 */
#define POLE_PAIRS_1  					4	//8		// Number of pole pairs
#define MAX_NOMINAL_SPEED_1  			3000//4000	// rpm
 ...
 */
#define GEAR_RATIO_1 					120		// if no gears are attached - set to gear ratio to 1
...
#define PROFILE_VELOCITY_1				2000	// rpm
#define MAX_ACCELERATION_1   			2000    // rpm/s
...
#define VELOCITY_Kd_DENOMINATOR_1 		1
...
#if(SENSOR_SELECTION_CODE_1 == QEI_INDEX || SENSOR_SELECTION_CODE_1 == QEI_NO_INDEX)
	#define POSITION_Kp_NUMERATOR_1 		660	// 250 	//180
	#define POSITION_Kp_DENOMINATOR_1  		80	//20
	#define POSITION_Ki_NUMERATOR_1    		1	//50	//50
	#define POSITION_Ki_DENOMINATOR_1  		25384//102
	#define POSITION_Kd_NUMERATOR_1    		0	//80	//100
	#define POSITION_Kd_DENOMINATOR_1  		1	//100
	...
	#define MAX_POSITION_LIMIT_1 			POLE_PAIRS_1*HALL_POSITION_INTERPOLATED_RANGE*GEAR_RATIO_1		// ticks (max range: 2^30, limited for safe operation) qei/hall/any position
	#define MIN_POSITION_LIMIT_1			-POLE_PAIRS_1*HALL_POSITION_INTERPOLATED_RANGE*GEAR_RATIO_1		// ticks (min range: -2^30, limited for safe operation) qei/hall/any position
#endif
